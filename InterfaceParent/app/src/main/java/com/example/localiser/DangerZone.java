...
public class DangerZone extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener/*, GeoQueryEventListener */{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(DangerZone.this, LocaliserMonEnfant.class);
                DangerZone.this.startActivity(myIntent);
            }
        });
    ...
    private void addQerry(LatLng latLng, float radius) {
        ...
        zones.child("danger").push().setValue(new CircleZone(latLng.latitude,latLng.longitude,radius));
    ...
    private void removeZones() {
        Query removeCircle = zones.child("danger");
