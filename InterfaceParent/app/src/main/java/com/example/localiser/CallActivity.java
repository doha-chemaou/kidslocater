...
public class CallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toggleVideo.setImageResource((video)?R.drawable.ic_baseline_videocam_24:R.drawable.ic_baseline_videocam_off_24);
            }
        });
       ...
       /* else{
            new AlertDialog.Builder(CallActivity.this)
                    .setTitle("Erreur")
                    .setMessage("Vous avez pas accepter les permissions !")
    ...
    private void sendCallRequest() {
        ...
        mDatabaseRef.child("fils").child("incoming").setValue(user);
        mDatabaseRef.child("fils").child("isAvailable").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void listenConnectionId() {
        mDatabaseRef.child("fils").child("connId").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
