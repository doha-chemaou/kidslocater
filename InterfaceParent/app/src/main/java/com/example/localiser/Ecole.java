...
public class Ecole extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ecole != null){
                    new AlertDialog.Builder(Ecole.this)
                            .setTitle("La position de l'ecole")
                            .setMessage("Vous Confirmer la position de l'ecole ?")
                            .setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    Log.d(TAG, "onClick: yes");
                                    zones.child("ecole").setValue(new CircleZone(ecole.latitude,ecole.longitude,Ecole_Radius));
                                }})
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                m=mMap.addMarker(new MarkerOptions().position(latLng).title("Ecole"));
                ecole= m.getPosition();
