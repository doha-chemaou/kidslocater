...
public class MediumZones implements GeoQueryEventListener {
    private static final String TAG = "MediumZones";
...
String token;
    ...
    private void addQerries() {
        ...
        for(CircleZone c : circleZones){
            ...
            geoQuery.addGeoQueryEventListener(MediumZones.this);
    ...
    public void initGeoZones(){
        ...
        zones.child("medium").addChildEventListener(new ChildEventListener() {
            @Override
       ...
       Token = rootNode.getReference("NotificationToken");
        ...
        Token.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                NotificationBody data = new NotificationBody("Danger","Votre fils a entrer dans une zone qui est  dangereuse");
